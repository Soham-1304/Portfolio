...
export const skillCategories: SkillGroup[] = [
  {
    ...
    skills: [
      ...
      { name: "C++", experience: "3+ yrs", focus: "DSA, Competitive Programming", logo: dv("cplusplus"), tier: "gold" },
      { name: "JavaScript", experience: "3+ yrs", focus: "Node.js, Express, React 19", logo: dv("javascript"), tier: "gold" },
      { name: "React", experience: "2+ yrs", focus: "React 19, Components, State", logo: dv("react"), tier: "silver" },
      { name: "SQL", experience: "2+ yrs", focus: "PostgreSQL, MySQL, RLS", logo: dv("azuresqldatabase"), tier: "silver" },
      { name: "Java", experience: "1 yr", focus: "OOP, Collections, Backend", logo: dv("java"), tier: "bronze" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "WebSockets", experience: "1.5+ yrs", focus: "Socket.IO, Live Streams", logo: dv("socketio"), tier: "silver" },
      { name: "GraphQL", experience: "1 yr", focus: "Schemas, Resolvers, Query Design", logo: dv("graphql", "plain"), tier: "bronze" },
  ...
  },
  {
    ...
    skills: [
      { name: "MySQL", experience: "3+ yrs", focus: "Relational Modeling, Indexing", logo: dv("mysql"), tier: "gold" },
      { name: "MongoDB", experience: "3+ yrs", focus: "Mongoose, Scalable Schemas", logo: dv("mongodb"), tier: "gold" },
      { name: "Redis", experience: "2+ yrs", focus: "TTL Tokens, In-Memory Caching", logo: dv("redis"), tier: "silver" },
      { name: "PostgreSQL", experience: "1 yr", focus: "Supabase, Row-Level Security", logo: dv("postgresql"), tier: "bronze" },
      { name: "Neo4j", experience: "1 yr", focus: "Graph Database, Cypher Queries", logo: dv("neo4j"), tier: "bronze" },
      { name: "Supabase", experience: "2+ yrs", focus: "Auth, Storage, RLS Policies", logo: dv("supabase"), tier: "silver" },
      { name: "Firebase", experience: "1 yr", focus: "Realtime DB, Cloud Firestore", logo: dv("firebase"), tier: "bronze" },
    ],
  },
  {
    ...
    skills: [
      { name: "NumPy & Pandas", experience: "2+ yrs", focus: "Data Wrangling, Pipelines", logo: dv("pandas"), tier: "silver" },
      { name: "LangChain", experience: "1 yr", focus: "RAG Chains, Vector Stores, Agents", logo: "https://cdn.simpleicons.org/langchain/1C3C3C", tier: "bronze" },
      { name: "n8n", experience: "1 yr", focus: "Workflow Automation, Agent Webhooks", logo: "https://cdn.simpleicons.org/n8n/EA4B71", tier: "bronze" },
      { name: "Gemini & Vertex AI", experience: "1 yr", focus: "Multimodal AI, LLM Pipelines", logo: dv("google"), tier: "bronze" },
      { name: "Hugging Face", experience: "1 yr", focus: "Transformers, Tokenizers, Models", logo: "https://huggingface.co/front/assets/huggingface_logo-noborder.svg", tier: "bronze" },
      { name: "Matplotlib (3D)", experience: "1.5+ yrs", focus: "CAD & Nodal Load Plotting", logo: dv("matplotlib"), tier: "silver" },
      { name: "LightGBM & ONNX", experience: "1 yr", focus: "CPU Risk Inference", logo: dv("scikitlearn"), tier: "bronze" },
      { name: "NetworkX", experience: "1 yr", focus: "Graph Swarm & Mule Centrality", logo: dv("networkx", "original"), tier: "bronze" },
    ],
  },
  {
    name: "DevOps & Cloud",
    ...
    skills: [
      ...
      { name: "Kubernetes", experience: "1 yr", focus: "K8s, Pods, Cluster Deployments", logo: dv("kubernetes", "plain"), tier: "silver" },
      { name: "Linux", experience: "2+ yrs", focus: "Shell Scripting, System Administration", logo: dv("linux"), tier: "silver" },
      { name: "AWS", experience: "1+ yr", focus: "EC2, App Runner, API Gateway", logo: dv("amazonwebservices", "original-wordmark"), tier: "bronze" },
      { name: "Git & GitHub", experience: "3+ yrs", focus: "Rebase, PR Cycles, FOSSEE", logo: dv("git"), tier: "gold" },
      { name: "Nginx", experience: "1+ yr", focus: "Reverse Proxy, TLS", logo: dv("nginx"), tier: "bronze" },
      { name: "Vercel & Render", experience: "2+ yrs", focus: "Production Deployments", logo: dv("vercel"), tier: "silver" },
    ],
  },
  {
    ...
    skills: [
      { name: "DSA", experience: "3+ yrs", focus: "280+ LeetCode Solved", logo: dv("leetcode"), tier: "gold" },
      { name: "System Design", experience: "2+ yrs", focus: "Microservices, WebSockets", logo: dv("networkx", "original"), tier: "gold" },
      { name: "DBMS & OS", experience: "2+ yrs", focus: "Transactions, Concurrency", logo: dv("linux"), tier: "silver" },
      { name: "Computer Networks", experience: "2+ yrs", focus: "TCP/IP, REST, WebSockets", logo: dv("networkx", "original"), tier: "silver" },
    ],
  },
]
...
export const topSkills: SkillItem[] = [
  ...
  { name: "C++", experience: "3+ yrs", focus: "DSA, Competitive Programming", logo: dv("cplusplus"), tier: "gold" },
  { name: "Node.js", experience: "2+ yrs", focus: "Express, Async I/O, REST", logo: dv("nodejs"), tier: "gold" },
  { name: "Express.js", experience: "2+ yrs", focus: "Controller-Service, Middleware", logo: dv("express", "original"), tier: "gold" },
  { name: "MongoDB", experience: "3+ yrs", focus: "Mongoose, Scalable Schemas", logo: dv("mongodb"), tier: "gold" },
  { name: "Docker", experience: "2+ yrs", focus: "Containers, Multi-stage", logo: dv("docker"), tier: "gold" },
  { name: "DSA", experience: "3+ yrs", focus: "280+ LeetCode Solved", logo: dv("leetcode"), tier: "gold" },
  { name: "System Design", experience: "2+ yrs", focus: "Microservices, WebSockets", logo: dv("networkx", "original"), tier: "gold" },
